...
class StudentPortalController extends Controller
{
    public function dashboard()
    {
        ...
        // Fetch all active courses for selection
        $courses = Course::where('status', true)->get();

        // Calculate Monthly Fee details
        ...
        // Fetch biometric attendance fines for current month
    ...
    public function selectCourse(Request $request)
    {
        ...
        // Update student course, course fee defaults
