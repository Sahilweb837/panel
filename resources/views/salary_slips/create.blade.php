        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            function fetchDeduction() {
                ...
                if(employeeId && month && year) {
                    fetch(`/salary_slips/calculate_deduction?employee_id=${employeeId}&month=${month}&year=${year}`)
            ...
            employeeSelect.addEventListener('change', fetchDeduction);
            monthInput.addEventListener('change', fetchDeduction);
            yearInput.addEventListener('change', fetchDeduction);
