                ...
                <div class="feature-cards">
                    <div class="glass-feature">
                        ...
                        <div>
                            ...
                            <p>Real-time performance insights across modules.</p>
                        </div>
                    </div>
                    <div class="glass-feature">
                        <div class="glass-feature-icon">
                        ...
                        <div>
                            ...
                            <p>Bank-grade data encryption and role management.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="login-form-container">
                ...
                <form method="POST" action="{{ route('login.post') }}" class="login-form">
                    ...
                    <div class="form-floating">
                        ...
                        <label for="login_id"><i class="fas fa-envelope"></i> Admin Email / Username</label>
                    </div>
