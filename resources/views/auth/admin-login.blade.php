...
<head>
    ...
    <title>Management Panel Login | Fees Manager</title>
    ...
    <style>
        ...
        .role-badge { display: inline-block; background: rgba(255, 85, 50, 0.1); color: var(--brand-primary); padding: 6px 16px; border-radius: 50px; font-weight: 600; font-size: 0.85rem; margin-bottom: 1rem; border: 1px solid rgba(255, 85, 50, 0.2); }
        ...
        .form-control:focus { border-color: var(--brand-primary); box-shadow: 0 0 0 4px rgba(255, 85, 50, 0.1); background-color: var(--input-bg); }
        ...
        .btn-primary-custom { width: 100%; height: 60px; border-radius: 16px; background: var(--brand-primary); color: white; font-size: 1.1rem; font-weight: 600; border: none; display: flex; align-items: center; justify-content: center; gap: 10px; transition: all 0.3s ease; box-shadow: 0 8px 20px rgba(255, 85, 50, 0.25); }
        .btn-primary-custom:hover { transform: translateY(-2px); box-shadow: 0 12px 25px rgba(255, 85, 50, 0.35); background: var(--brand-primary-dark); }
            ...
            <div class="left-content-wrapper">
                ...
                <div class="feature-cards">
                    <div class="glass-feature">
                        ...
                        <div><h4>Smart Analytics</h4><p>Real-time performance insights across modules.</p></div>
                    </div>
                    <div class="glass-feature">
                        <i class="fas fa-shield-alt"></i>
                        <div><h4>Enterprise Security</h4><p>Bank-grade data encryption and role management.</p></div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="login-right">
            <div class="login-form-container">
                <div class="form-header">
                    <div class="role-badge"><i class="fas fa-user-shield me-1"></i> Admin Access</div>
                    <h2>Welcome Back</h2>
                ...
                <form method="POST" action="{{ route('login.post') }}" class="login-form">
                    @csrf
                    <input type="hidden" name="account_type" value="institute">
                    ...
                    <div class="form-floating">
                        ...
                        <label for="login_id"><i class="fas fa-envelope me-2"></i> Admin Email / Username</label>
                    </div>
