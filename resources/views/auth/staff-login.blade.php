...
<head>
    ...
    <style>
        :root {
            ...
            --gradient-left: linear-gradient(135deg, #e6fdf5 0%, #d1fae5 100%);
        }
                ...
                <div class="feature-cards">
                    <div class="glass-feature">
                        ...
                        <div>
                            ...
                            <p>Seamless biometric logging and attendance records.</p>
                        </div>
                    </div>
                    <div class="glass-feature">
                        <div class="glass-feature-icon">
                        ...
                        <div>
                            ...
                            <p>Instant access to digital slips and documents.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="login-form-container">
                ...
                <form method="POST" action="{{ route('login.post') }}" class="login-form">
                    ...
                    <div class="form-floating">
                        <input type="text" class="form-control @error('email') is-invalid @enderror" id="login_id" name="login_id" value="{{ old('login_id', old('email')) }}" placeholder="Email or Username" required autocomplete="username">
                        <label for="login_id"><i class="fas fa-id-badge"></i> Employee Email / Username</label>
                    </div>
