...
<head>
    ...
    <title>Staff Portal Login | Fees Manager</title>
    ...
    <style>
        ...
        .role-badge { display: inline-block; background: rgba(16, 185, 129, 0.1); color: var(--brand-primary); padding: 6px 16px; border-radius: 50px; font-weight: 600; font-size: 0.85rem; margin-bottom: 1rem; border: 1px solid rgba(16, 185, 129, 0.2); }
        ...
        .form-control:focus { border-color: var(--brand-primary); box-shadow: 0 0 0 4px rgba(16, 185, 129, 0.1); background-color: var(--input-bg); }
        ...
        .btn-primary-custom { width: 100%; height: 60px; border-radius: 16px; background: var(--brand-primary); color: white; font-size: 1.1rem; font-weight: 600; border: none; display: flex; align-items: center; justify-content: center; gap: 10px; transition: all 0.3s ease; box-shadow: 0 8px 20px rgba(16, 185, 129, 0.25); }
        .btn-primary-custom:hover { transform: translateY(-2px); box-shadow: 0 12px 25px rgba(16, 185, 129, 0.35); background: var(--brand-primary-dark); }
    ...
    <div class="login-wrapper">
        <div class="login-left">
            ...
            <div class="left-content-wrapper">
                ...
                <h1 class="left-title">Staff <br><span>Hub</span></h1>
                <p class="left-subtitle">Streamlined tools for modern educators.</p>
                <div class="feature-cards">
                    <div class="glass-feature">
                        <i class="fas fa-clipboard-check"></i>
                        <div><h4>Automated Attendance</h4><p>Seamless management and integration.</p></div>
                    </div>
                    <div class="glass-feature">
                        <i class="fas fa-wallet"></i>
                        <div><h4>Payroll History</h4><p>Instant access to digital slips and documents.</p></div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="login-right">
            <div class="login-form-container">
                <div class="form-header">
                    <div class="role-badge"><i class="fas fa-chalkboard-teacher me-1"></i> Staff Access</div>
                    <h2>Welcome Back</h2>
                ...
                <form method="POST" action="{{ route('login.post') }}" class="login-form">
                    ...
                    <div class="form-floating">
                        <input type="text" class="form-control @error('email') is-invalid @enderror" id="login_id" name="login_id" value="{{ old('login_id', old('email')) }}" placeholder="Email or Username" required>
                        <label for="login_id"><i class="fas fa-id-badge me-2"></i> Employee Email / Username</label>
                    </div>
