...
@section('page-title', 'Edit Training Course')
            ...
            <div class="card premium-form-card" style="max-width: 750px;">
                <div class="card-header bg-transparent border-bottom mb-4 pb-3">
                    <h3 class="mb-0 fw-bold text-first">
                        <i class="fas fa-graduation-cap me-2"></i>Edit Training Course
                    </h3>
                </div>

                <form action="{{ route('training_courses.update', $trainingCourse) }}" method="POST" class="form-card p-0">
                    @csrf
                    @method('PUT')
                    <div class="form-group-grid mb-4">
                        <div class="form-group">
                            ...
                            <input type="text" id="name" name="name" value="{{ old('name', $trainingCourse->name) }}" required placeholder="e.g. PHP Full Stack" class="form-input {{ $errors->has('name') ? 'is-invalid' : '' }}" />
                            @error('name')
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="short_code" name="short_code" value="{{ old('short_code', $trainingCourse->short_code) }}" placeholder="e.g. PHPFS" maxlength="50" class="form-input" />
                        </div>
                    </div>
                    ...
                    <div class="form-group-grid mb-4">
                        <div class="form-group">
                            ...
                            <select id="duration" name="duration" required class="form-input {{ $errors->has('duration') ? 'is-invalid' : '' }}">
                                @foreach($durations as $duration)
                                    <option value="{{ $duration }}" {{ old('duration', $trainingCourse->duration) == $duration ? 'selected' : '' }}>{{ $duration }}</option>
                                @endforeach
                            </select>
                            @error('duration')
                                <small style="color: var(--danger-text);" class="mt-1 d-block">{{ $message }}</small>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" id="fee" name="fee" step="0.01" value="{{ old('fee', $trainingCourse->fee) }}" required placeholder="0.00" class="form-input {{ $errors->has('fee') ? 'is-invalid' : '' }}" />
                            @error('fee')
                                <small style="color: var(--danger-text);" class="mt-1 d-block">{{ $message }}</small>
                            @enderror
                        </div>
                    ...
                    <div class="form-group mb-4">
                        ...
                        <div class="form-group-grid mb-3" style="grid-template-columns: repeat(4, 1fr);">
                            <div class="form-group">
                                ...
                                <input type="number" id="tenure_1_month" name="tenure_1_month" step="0.01" value="{{ old('tenure_1_month', $trainingCourse->tenure_1_month) }}" placeholder="0.00" class="form-input" />
                            </div>
                            <div class="form-group">
                                <label for="tenure_3_months" class="fw-semibold mb-2" style="font-size: 0.8rem;">3 Months</label>
                                <input type="number" id="tenure_3_months" name="tenure_3_months" step="0.01" value="{{ old('tenure_3_months', $trainingCourse->tenure_3_months) }}" placeholder="0.00" class="form-input" />
                            </div>
                            <div class="form-group">
                                <label for="tenure_6_months" class="fw-semibold mb-2" style="font-size: 0.8rem;">6 Months</label>
                                <input type="number" id="tenure_6_months" name="tenure_6_months" step="0.01" value="{{ old('tenure_6_months', $trainingCourse->tenure_6_months) }}" placeholder="0.00" class="form-input" />
                            </div>
                            <div class="form-group">
                                <label for="tenure_12_months" class="fw-semibold mb-2" style="font-size: 0.8rem;">12 Months</label>
                                <input type="number" id="tenure_12_months" name="tenure_12_months" step="0.01" value="{{ old('tenure_12_months', $trainingCourse->tenure_12_months) }}" placeholder="0.00" class="form-input" />
                            </div>
                        </div>
                    ...
                    <div class="form-group mb-4">
                        ...
                        <textarea id="description" name="description" rows="3" placeholder="Brief course description..." class="form-input" style="resize: vertical;">{{ old('description', $trainingCourse->description) }}</textarea>
                    </div>

                    <div class="form-group checkbox-group mb-4">
                        <label class="checkbox-label" style="cursor: pointer;">
                            <input type="checkbox" name="status" value="1" {{ old('status', $trainingCourse->status) ? 'checked' : '' }} class="checkbox-input" />
