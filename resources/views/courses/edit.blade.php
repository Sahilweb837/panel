            ...
            <div class="card premium-form-card">
                <div class="card-header bg-transparent border-bottom mb-4 pb-3">
                    <h3 class="mb-0 fw-bold text-first">
                        <i class="fas fa-book-open me-2"></i>Modify Academic Course Settings
                    </h3>
                </div>
                    ...
                    <div class="form-group-grid mt-3">
                        <div class="form-group">
                            ...
                            <select id="duration" name="duration" class="form-input">
                                ...
                                <option value="45 Days" {{ old('duration', $course->duration) === '45 Days' ? 'selected' : '' }}>45 Days</option>
                                <option value="1 Month" {{ old('duration', $course->duration) === '1 Month' ? 'selected' : '' }}>1 Month</option>
                                <option value="3 Months" {{ old('duration', $course->duration) === '3 Months' ? 'selected' : '' }}>3 Months</option>
                                <option value="6 Months" {{ old('duration', $course->duration) === '6 Months' ? 'selected' : '' }}>6 Months</option>
