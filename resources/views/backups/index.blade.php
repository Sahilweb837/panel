                            ...
                            @forelse($backups as $backup)
                                <tr>
                                    ...
                                    <td class="text-end pe-4 action-cell">
                                        ...
                                        <form action="{{ route('backups.restore', base64_encode($backup['name'])) }}" method="POST" class="inline-form d-inline me-1" onsubmit="return confirmAction(event, 'WARNING: This will overwrite the current database with this backup. Are you absolutely sure?');">
                                            @csrf
                                        ...
                                        <form action="{{ route('backups.destroy', base64_encode($backup['name'])) }}" method="POST" class="inline-form d-inline" onsubmit="return confirmAction(event, 'Are you sure you want to delete this backup file?');">
                                            @csrf
                                            @method('DELETE')
